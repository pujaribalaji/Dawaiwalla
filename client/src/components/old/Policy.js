  ...
  <div>
      <div style={{ textAlign: "center" }}>
        <img
          ...
          style={{ width: "100%", height: 300, maxWidth: "100%", height: "auto" }}
          alt="Privacy Policy"
        />
      </div>
      ...
      <section style={{ paddingBottom: "20px", paddingTop: "50px" }}>
        <div style={{ backgroundColor: "#f8f9fa", marginTop: "5rem", paddingTop: "3rem" }}>
          <div style={{ textAlign: "center", paddingBottom: "20px" }}>
            <h2 style={{ textTransform: "uppercase", fontSize: "2rem" }}>QUALITY & SAFETY ASSURED BEFORE DELIVERY</h2>
            <hr style={{ margin: "auto", width: "20%", marginBottom: "1rem", borderTop: "2px solid #333" }} />
          </div>
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <div style={{ textAlign: "center" }}>
              <img
                src="images/temperature-controlled-icon.png"
                style={{ width: "10%", maxWidth: "50px" }}
                alt="Temperature Controlled storage and delivery"
              />
              <h5><b>Temperature Controlled storage and delivery</b></h5>
            </div>
            <div style={{ textAlign: "center" }}>
              <img
              ...
              />
              <h5><b>Regular Sanitization</b></h5>
            </div>
            <div style={{ textAlign: "center" }}>
              <img
            ...
            <div style={{ textAlign: "center" }}>
              ...
              />
              <h5><b>Disinfected Packaging</b></h5>
            </div>
          </div>
        </div>
      </section>
...
<section className="ptb50" style={{ paddingBottom: "20px" }}>
  ...
  return (
    <Layout title={"Privacy Policy - Dawaiwalla"}>
      ...
      <section className="ptb50" style={{ paddingBottom: "20px" }}>
        <div
          className="container carousel-wrap bg-light mt-5 pt-3"
          style={{ textAlign: "center" }}
        >
          <div className="text-center pb20">
            <h2 className="catHeading uppercase">
